...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("step_snow")
				soundin = pick('sound/footstep/stepSnow1.ogg', 'sound/footstep/stepSnow2.ogg', 'sound/footstep/stepSnow3.ogg')
			if ("step_sand")
				soundin = pick('sound/footstep/stepSand1.ogg', 'sound/footstep/stepSand2.ogg', 'sound/footstep/stepSand3.ogg')
			if ("step_shoes")
