//Sabatier Reactor:
//CO2 + 4 H2 -> CH4 + 2 H2O + energy. Needs a small amount of power to heat the gasses to 350C. Inputs the gasses seperately.
/obj/machinery/atmospherics/components/trinary/sabatier
	...
	var/node1_concentration = 0.2 //CO2
	var/node2_concentration = 0.8 //H2

	//node 3 is the outlet, nodes 1 & 2 are intakes

/obj/machinery/atmospherics/components/trinary/sabatier/flipped
	icon_state = "mixer_off_f"
	flipped = 1

/obj/machinery/atmospherics/components/trinary/sabatier/update_icon()
	cut_overlays()
...
/obj/machinery/atmospherics/components/trinary/sabatier/update_icon_nopipes()
...
/obj/machinery/atmospherics/components/trinary/sabatier/power_change()
	var/old_stat = stat
	..()
	if(stat & NOPOWER)
		on = 0
...
/obj/machinery/atmospherics/components/trinary/sabatier/New()
	..()
	var/datum/gas_mixture/air3 = AIR3
	air3.volume = 300
	AIR3 = air3

/obj/machinery/atmospherics/components/trinary/sabatier/process_atmos()
	..()
	if(!on)
		return 0
	...
	//Convert the transferred gas into methane and water
/*	if(air3)
		if(
...
/obj/machinery/atmospherics/components/trinary/sabatier/ui_interact(mob/user, ui_key = "main", datum/tgui/ui = null, force_open = 0, \
...
/obj/machinery/atmospherics/components/trinary/sabatier/ui_data()
	var/data = list()
	data["on"] = on
...
/obj/machinery/atmospherics/components/trinary/sabatier/ui_act(action, params)
	if(..())
		return
	switch(action)
		if("power")
